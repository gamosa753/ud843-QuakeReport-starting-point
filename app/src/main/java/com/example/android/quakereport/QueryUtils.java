    ...
    public static ArrayList<Earth> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                final String url = prop.getString("url");
                currentEarthquake.setOnClickListener(new View.OnClickListener() {
                ...
                Earth earthquake = new Earth(mag, place, time, location);
